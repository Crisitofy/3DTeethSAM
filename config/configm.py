def get_default_config():
    return {
        ...
        'freeze_classification_heads': False,
        
        'classification_head_nhead': 4, 
        'classification_head_dropout': 0.35, 
        'classification_head_num_decoder_layers': 4, 
        'classification_head_decoder_dim_feedforward': 1024, 
